...
jQuery(document).ready(function(){
  setTimeout(function(){ 
    ...
    //   jQuery('body').toggleClass('main-hidden');
    //   jQuery('body').toggleClass('sub-hidden');
    // });

    // jQuery('.menu .scroll').perfectScrollbar();

    jQuery('.main-menu ul').on('click', 'li', function() {
...
$.dore = function (element, options) {
  ...
  function init() {
    ...
    if (typeof Chart !== "undefined") {
      ...
      if (document.getElementById("categoryChart")) {
        ...
        var myDoughnutChart = new Chart(categoryChart, {
          ...
          data: {
            labels: ["Used Licenses", "Remaining Licenses"],
            datasets: [
              {
                label: "",
    ...
    //       sidebarScroll = new PerfectScrollbar($(this)[0], { suppressScrollX: true });
    //       sidebarScroll.isRtl = false;
    //       $(".main-menu .scroll").scrollTop(
    //         $(".main-menu .scroll").prop("scrollHeight")
    //       );
