...
export class ShareService {
  ...
  constructor(public utilsService: UtilsService, public formBuilder: FormBuilder, public datepipe: DatePipe) {
    ...
    this.frameworkComponents = { buttonRenderer: ButtonRendererComponent, shareCopyLinkButtonRenderer: ShareCopyLinkButtonRendererComponent, otherShareButtonRenderer: OtherShareButtonRendererComponent };
...
*/
  ...
  openUrlInNewTab(event) {
    ...
    window.open(UtilsService.FRONT_URL + 'share/sharedAssets/' + obj.link_token, '_blank');
  }
