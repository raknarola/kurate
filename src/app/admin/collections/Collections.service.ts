...
export class CollectionsService {
  ...
  constructor(public utilsService: UtilsService, public datepipe: DatePipe, public formBuilder: FormBuilder) {
    this.flagForHideShowCollection = false;
    this.frameworkComponents = { buttonRenderer: ButtonRendererComponent, shareButtonRenderer: ShareCollectionButtonRendererComponent, checkboxRenderer: CheckboxRenderComponent };
