...
import {
  HttpClient, HttpHeaders, HttpEventType,
  HttpResponse
...
export class AssetsService {
  ...
  orderByForGridView: string = 'created_at';
  orderByForListView: string = 'created_at';
  ...
  removeAndSearchAgain(index) {
    // console.log(index);
    // console.log(this.utilsService.arrayOfSearchedTags[index]);
  ...
  selectUnselectAsset(assetId: number, index, value) {
    // console.log(assetId);
    // console.log(index);
    // console.log(this.utilsService.arrayOfSelectedAssets);
