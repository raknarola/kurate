...
@Component({
 ...
 <a (click)="onClick($event, 'CopyShareLink')"   matTooltip="Copy-Share-Link" style="font-size:small;cursor: pointer;">
...
export class ShareCopyLinkButtonRendererComponent implements ICellRendererAngularComp {
